        ...
        try {
          ...
          if (pLower.includes('calendar') || pLower.includes('schedule') || pLower.includes('appointment') || pLower.includes('deadline')) {
            ...
            if (pLower.includes('are you real') || pLower.includes('who are you') || pLower.includes('what are you') || pLower.includes('your name')) {
              fallbackText = `Yes, I am **LGPAI (Life Guide Personal AI Assistant)**, your personal AI assistant. I'm here to dive into whatever you need—analyzing data, writing code, generating insights, checking live weather, or managing schedules.`;
              ...
              fallbackText = `### ${pClean}\n\nHere is a breakdown to help you with **${pClean}**:\n\n- **Direct Strategy**: Focus on executing the core objective with high precision.\n- **Action Steps**: Implement the required steps systematically to achieve the desired outcome.\n\nLet me know if you would like me to dive deeper into any specific aspect or run code for this.`;
            }
          }
